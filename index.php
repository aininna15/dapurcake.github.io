...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #0665ad; border-bottom: 2px solid #0665ad;">Dapur Cake adalah salah satu toko kue yang ada di Camba. Didirikan pada tahun 2010.Produk kami sehat, bergizi, dan terjangkau oleh semua orang.</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid #0665ad; margin-top: 80px;"><b>Produk Kami</b></h2>
