...
<body>
	<div class="container-fluid">
		<div class="row top" style="background-color: #0665ad">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6282349263515</span>
				</div>


				<div class="col-md-4" style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> dapurcake@gmail.com</span>
				</div>


				<div class="col-md-4" style="padding: 3px;">
					<span>Dapur Cake</span>
				</div>
			</center>
		</div>
	</div>

	<nav class="navbar " style="padding: 5px; padding-left:550px;">
		<div class="container">
				...
				<div class="collapse navbar-collapse  navbar-right " id="bs-example-navbar-collapse-2">
					<div class="">
						...
						<ul class="nav navbar-nav">
							<li><a class="navbar-brand" href="#" style="color: #0665ad">AINUN MUTMAINNA</a></li>
